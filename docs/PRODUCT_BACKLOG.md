...
## ALT-10 — Mission Learning Path

### Descripción

Agregar una capa de aprendizaje guiado antes y durante cada misión.

Actualmente el estudiante entra directamente al chat con el tutor IA.
La misión depende completamente de la capacidad del estudiante para descubrir
el contenido durante la conversación.

Mission Learning Path introduce una experiencia híbrida:

1. Learning Objectives
2. Vocabulary Guide
3. Grammar Focus
4. Examples
5. AI Generated Mini Quiz
6. Mission Learning Guide Screen
7. Tutor Context Enrichment

El objetivo es que el estudiante llegue preparado a la conversación con el tutor.

### Historias

#### Story 1 — Learning Objectives

Como estudiante
quiero conocer los objetivos de aprendizaje de la misión
para saber qué debo dominar al finalizar.

#### Story 2 — Vocabulary Guide

Como estudiante
quiero revisar vocabulario clave antes de comenzar
para comprender mejor la conversación.

#### Story 3 — Grammar Focus

Como estudiante
quiero conocer la estructura gramatical principal
para usarla durante la misión.

#### Story 4 — Examples

Como estudiante
quiero ver ejemplos contextualizados
para entender cómo utilizar el vocabulario y la gramática.

#### Story 5 — AI Generated Mini Quiz

Como estudiante
quiero resolver ejercicios rápidos
para validar mi comprensión antes de conversar.

#### Story 6 — Mission Learning Guide Screen

Como estudiante
quiero una pantalla de preparación
que me guíe paso a paso antes de iniciar la misión.

#### Story 7 — Tutor Context Enrichment

Como tutor IA
quiero recibir el contexto pedagógico de la misión
para reforzar los objetivos durante la conversación.

### Valor para el usuario

- Reduce ansiedad.
- Incrementa comprensión.
- Aumenta éxito en la misión.
- Mejora retención de vocabulario.

### Valor para el negocio

- Diferencia Activa Inglés de un chatbot genérico.
- Mejora resultados pedagógicos.
- Facilita adopción institucional.
- Incrementa tiempo de permanencia.
...
## 3. Próxima iniciativa estratégica recomendada

### ALT-10 — Mission Learning Path

Motivo:

Activa Inglés ya cuenta con:
...
La siguiente evolución natural del producto es
transformar las misiones en experiencias de aprendizaje guiadas.

Mission Learning Path agregará:
...
- Mayor valor para instituciones educativas
